...
public class GestionDocView extends JFrame {
    ...
    public GestionDocView() {
        setTitle("Gestion du Catalogue de Documents");
        setSize(1000, 680);
        ...
        JLabel lblTitre = new JLabel("REGISTRE GÉNÉRAL DES DOCUMENTS", SwingConstants.CENTER);
        ...
        String[] columns = {"ID", "Titre", "Auteur", "Type", "Exemplaires"};
